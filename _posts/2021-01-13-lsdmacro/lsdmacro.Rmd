...
>
EQUATION( "Q_TOT" )  <p style="color:green;">
/*  
...
{   <p style="color:green;"> 
  ...
  // Pode haver qualquer comando aqui  </p>
}  
...
for ( i = -2; i < 3; i++ )  
{<p style="color:green;"> 
  // na execução dessas linhas, i assume os valores -2, -1, 0, 1, 2 </p>
  v[i] = i;  
} <p style="color:green;">   
// aqui, i é igual a 3, porque foi a condição para sair do ciclo </p>  
