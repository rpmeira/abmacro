...
citation_url: https://rpmeira.github.io/EqDiff
...
Por exemplo, seja a equação em diferença $x_t = x_{t-1}^2$. A função $f(x) = x^2$ apresenta dois pontos fixos: $0$ e $1$. O que é fácil de se verificar: $0^2 = 0$ e $1^2 = 1$. 
