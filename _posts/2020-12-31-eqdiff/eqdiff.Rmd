...
Um ponto fixo é **estável** se pontos pertos dele convergem para o ponto fixo quando são iterados. Por outro lado, um ponto fixo é **instável** se pontos perto dele divergem do ponto fixo quando são iterados.
